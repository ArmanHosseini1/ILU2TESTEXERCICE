...
class WelcomeTest {
	...
	void testYoda() {
		...
		assertEquals("Hello, Bob and Amy. AND YODA (*2) AND JERRY, HELLO !", Welcome.welcome("bob, YODA, amy, JERRY, YODA"));
		assertEquals("Yoda and Bob (*2), Hello. AND YODA, HELLO !", Welcome.welcome("yoda, bob, YODA, Bob"));
	}
}
